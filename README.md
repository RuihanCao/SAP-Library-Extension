...
History sync button is pinned to SAP API `0.48` by default, while replay injection still auto-detects the live API version from SAP traffic and falls back to `0.48` if no version has been observed yet.
